...
**Output contract:** evolve is not done until this entry exists (this skill: `EVOLUTION.md`; other projects: `wiki/decisions.md` + `log.md`). See `../core/references/wiki-protocol.md` → Output Contract. Maintain in the skill repo:
